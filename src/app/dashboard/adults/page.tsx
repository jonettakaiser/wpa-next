...
import Image from 'next/image';
    ...
    const AdultsPage: React.FC = () => {
        const categories = [
          { name: 'Commercials', link: '/dashboard/adults/commercials', image: '/media/commercial.jpg' },
          { name: 'Monologues', link: '/dashboard/adults/monologues', image: '/media/monologue.jpg' },
          { name: 'TV', link: '/dashboard/adults/tv', image: '/media/tv.jpg' },
        ];
  return (
