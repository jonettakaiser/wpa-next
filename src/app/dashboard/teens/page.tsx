...
import Image from 'next/image';
    ...
    const TeensPage: React.FC = () => {
        const categories = [
          { name: 'Commercials', link: '/dashboard/teens/commercials', image: '/media/commercial.jpg' },
          { name: 'Monologues', link: '/dashboard/teens/monologues', image: '/media/monologue.jpg' },
          { name: 'TV', link: '/dashboard/teens/tv', image: '/media/tv.jpg' },
        ];
  return (
