...
import Image from 'next/image';
    ...
    const ChildrenPage: React.FC = () => {
        const categories = [
          { name: 'Commercials', link: '/dashboard/children/commercials', image: '/media/commercial.jpg' },
          { name: 'Monologues', link: '/dashboard/children/monologues', image: '/media/monologue.jpg' },
          { name: 'TV', link: '/dashboard/children/tv', image: '/media/tv.jpg' },
        ];
  return (
